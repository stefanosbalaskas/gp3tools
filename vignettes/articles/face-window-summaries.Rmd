---
title: "External face-data window summaries"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{External face-data window summaries}
...
This article demonstrates how to summarise externally generated facial-behaviour data inside analysis windows.
...
The output includes window identifiers, row counts, validity coverage, confidence summaries, and measure-level summaries.
...
`summarize_gazepoint_face_reactivity()` computes response minus baseline from a window-summary table.
...
The resulting `reactivity` value is a descriptive difference score. It should be interpreted as a change in a facial-behaviour measure, not as evidence of an emotional state.
