...
Use the 1-KM plot only for the single target event represented here. The hazard panel is an empirical event/risk diagnostic, not a smooth latent hazard estimate.
