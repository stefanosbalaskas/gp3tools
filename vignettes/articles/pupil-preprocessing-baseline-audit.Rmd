...
This article focuses on pupil preprocessing and baseline-readiness checks.
...
Baseline correction should be reported with the baseline window, minimum coverage rule, interpolation rule, excluded cases, and sensitivity checks.
