...
The code uses placeholder file paths and object names. Replace them with the paths and column names used in your own study.

# 1. Load example data

This vignette can be read as a template for private Gazepoint exports, but the package also includes lightweight synthetic example data.
...
For a real study, you would usually start by importing a Gazepoint export folder:
...
# 2. Create and validate the master table
